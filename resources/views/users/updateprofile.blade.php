                                ...
                                <div class="widget-header">                                
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                            <h4>Update Truck Driver Bio</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content widget-content-area">
                                    <form enctype="multipart/form-data" action="{{url('/updatprofil/update/'.Auth::user()->id)}}" method="post">
									@csrf
									<div class="form-row mb-4">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" name="email" class="form-control" value="{{Auth::user()->email}}" id="formGroupExampleInput" placeholder="Enter Email">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="formGroupExampleInput2">Contact NUmber</label>
                                            <input type="number" class="form-control"  name="mobile_no" id="formGroupExampleInput2" value="{{Auth::user()->mobile_no}}" placeholder="Enter Contact number">
                                        </div>
